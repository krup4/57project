workspace {
    ...
    model {
        ...
        system.wa -> system.db "Запись нового пользователя"

        user -> system.wa "Отправка файла для печати"
        system.wa -> system.server "Отправка файла на сервер печати"
        system.server -> system.printer "Запрос на печать файла"
        system.printer -> system.server "Уведомление о завершении печати / ошибке"
        system.server -> system.wa "Уведомление о завершении печати / ошибке"
        ...
        system.wa -> system.db "Запрос на получение всех нераспечатанных файлов"
        system.db -> admin "Все нераспечатанные файлы"
